...
import { b as inputHandleFocus, e as inputHandleBlur, f as inputHandleChange, s as stopEventBubbling, h as inputHandleClick, c as inputHandleHostClick, d as inputListenOnClick, j as inputHandleReset, i as inputSetFocus, a as inputSetBlur, g as getInputTarget } from './form-input.js';
...
const Input = proxyCustomElement(class Input extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
  ...
  static get style() { return {
    ...
    "multiple": [4],
    "pattern": [1],
    "allowedKeyPress": [1, "allowed-key-press"],
    "required": [4],
    "spellcheck": [4],
    "disabled": [4],
    "readonly": [4],
...
const BalInput = Input;
const defineCustomElement = defineCustomElement$1;

export { BalInput, defineCustomElement };
