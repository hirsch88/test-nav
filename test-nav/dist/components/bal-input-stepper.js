...
import { o as formatLocaleNumber } from './index.esm.js';
import { m as debounceEvent } from './helpers.js';
import { i as inheritAttributes } from './attributes.js';
import { d as inputListenOnClick } from './form-input.js';
...
const InputStepper = proxyCustomElement(class InputStepper extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    ...
    this.balDecrease = createEvent(this, "balDecrease", 7);
  ...
  components.forEach(tagName => { switch (tagName) {
    case "bal-input-stepper":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, InputStepper);
      }
      break;
    case "bal-button":
      if (!customElements.get(tagName)) {
...
const BalInputStepper = InputStepper;
const defineCustomElement = defineCustomElement$1;

export { BalInputStepper, defineCustomElement };
