...
import { l as loadFooterLinks, g as loadSocialMediaLinks, L as Language } from './index.esm.js';
import { e as updateBalLanguage } from './index2.js';
...
const Footer = proxyCustomElement(class Footer extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.links = [];
...
const BalFooter = Footer;
const defineCustomElement = defineCustomElement$1;

export { BalFooter, defineCustomElement };
