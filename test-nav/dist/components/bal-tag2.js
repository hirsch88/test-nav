...
import { d as defineCustomElement$2 } from './bal-close2.js';
...
const Tag = proxyCustomElement(class Tag extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement() {
  ...
  const components = ["bal-tag", "bal-close", "bal-icon"];
