...
const BalCheckboxButton$1 = proxyCustomElement(class BalCheckboxButton extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
], BalCheckboxButton$1.prototype, "createLogger", null);
__decorate([
  ListenToElementStates()
], BalCheckboxButton$1.prototype, "elementStateListener", null);
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["bal-checkbox-button"];
  components.forEach(tagName => { switch (tagName) {
    case "bal-checkbox-button":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, BalCheckboxButton$1);
      }
      break;
  } });
}

const BalCheckboxButton = BalCheckboxButton$1;
const defineCustomElement = defineCustomElement$1;

export { BalCheckboxButton, defineCustomElement };
