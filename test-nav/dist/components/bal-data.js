...
const Data = proxyCustomElement(class Data extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["bal-data"];
  components.forEach(tagName => { switch (tagName) {
    case "bal-data":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, Data);
      }
      break;
  } });
}
...
export { BalData, defineCustomElement };
