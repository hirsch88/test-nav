...
const DocTokensColors = proxyCustomElement(class DocTokensColors extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
  }
...
function defineCustomElement$1() {
  ...
  const components = ["bal-doc-tokens-colors", "bal-app", "bal-doc-app"];
  components.forEach(tagName => { switch (tagName) {
    case "bal-doc-tokens-colors":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DocTokensColors);
      }
      break;
    case "bal-app":
      if (!customElements.get(tagName)) {
...
const BalDocTokensColors = DocTokensColors;
const defineCustomElement = defineCustomElement$1;

export { BalDocTokensColors, defineCustomElement };
