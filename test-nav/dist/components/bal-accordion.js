...
import { l as raf, t as transitionEndAsync, m as debounceEvent, w as waitForComponent } from './helpers.js';
...
const Accordion = proxyCustomElement(class Accordion extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["bal-accordion", "bal-button", "bal-icon", "bal-spinner"];
...
const BalAccordion = Accordion;
const defineCustomElement = defineCustomElement$1;

export { BalAccordion, defineCustomElement };
