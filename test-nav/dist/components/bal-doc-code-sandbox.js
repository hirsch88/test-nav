...
import { d as defineCustomElement$6 } from './bal-app2.js';
import { d as defineCustomElement$5 } from './bal-button2.js';
import { d as defineCustomElement$4 } from './bal-doc-app2.js';
...
const DocCodeSandbox = proxyCustomElement(class DocCodeSandbox extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
  ...
  static get style() { return balDocCodeSandboxCss; }
}, [0, "bal-doc-code-sandbox", {
    "fullscreen": [4],
    "framework": [1],
    "modules": [1],
    "template": [1],
    "component": [1],
    "name2": [1, "name-2"],
    "template2": [1, "template-2"],
    "component2": [1, "component-2"],
    "visible": [4],
    "primary": [4],
    "logo": [4],
    "label": [1],
...
function defineCustomElement$1() {
  ...
  const components = ["bal-doc-code-sandbox", "bal-app", "bal-button", "bal-doc-app", "bal-icon", "bal-spinner"];
  components.forEach(tagName => { switch (tagName) {
    case "bal-doc-code-sandbox":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DocCodeSandbox);
      }
      break;
    case "bal-app":
      if (!customElements.get(tagName)) {
...
const BalDocCodeSandbox = DocCodeSandbox;
const defineCustomElement = defineCustomElement$1;

export { BalDocCodeSandbox, defineCustomElement };
