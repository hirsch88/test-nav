...
const DocLinkList = proxyCustomElement(class DocLinkList extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
  ...
  get el() { return this; }
  static get style() { return balDocLinkListCss; }
}, [4, "bal-doc-link-list", {
    "oneColumn": [4, "one-column"]
  }]);
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["bal-doc-link-list"];
  components.forEach(tagName => { switch (tagName) {
    case "bal-doc-link-list":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DocLinkList);
      }
      break;
  } });
}

const BalDocLinkList = DocLinkList;
const defineCustomElement = defineCustomElement$1;

export { BalDocLinkList, defineCustomElement };
