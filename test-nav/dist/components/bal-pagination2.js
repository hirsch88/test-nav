...
const Pagination = proxyCustomElement(class Pagination extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement() {
  ...
  const components = ["bal-pagination", "bal-button", "bal-icon", "bal-spinner", "bal-text"];
