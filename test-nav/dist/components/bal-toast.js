...
import { d as defineCustomElement$3 } from './bal-close2.js';
...
const Toast = proxyCustomElement(class Toast extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["bal-toast", "bal-close", "bal-icon"];
...
const BalToast = Toast;
const defineCustomElement = defineCustomElement$1;

export { BalToast, defineCustomElement };
