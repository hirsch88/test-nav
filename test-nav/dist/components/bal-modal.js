...
import { p as prepareOverlay, d as dismiss, e as eventMethod } from './overlays.js';
import { c as componentOnReady, e as deepReady, f as wait } from './helpers.js';
...
const Modal = proxyCustomElement(class Modal extends HTMLElement$1 {
  constructor() {
    super();
    this.__registerHost();
  ...
  static get style() { return {
    ...
    "overlayIndex": [1026, "overlay-index"],
    "delegate": [16],
    "dataTestId": [1, "data-test-id"],
    "modalWidth": [2, "modal-width"],
    "space": [1],
    "hasBackdrop": [4, "has-backdrop"],
    ...
    "onDidDismiss": [64],
    "onWillDismiss": [64]
  }, [[0, "click", "onClickCloseButton"], [1, "mousedown", "onMouseDown"], [1, "mouseup", "onMouseUp"], [16, "keyup", "handleKeyUp"]]]);
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["bal-modal"];
...
const BalModal = Modal;
const defineCustomElement = defineCustomElement$1;

export { BalModal, defineCustomElement };
