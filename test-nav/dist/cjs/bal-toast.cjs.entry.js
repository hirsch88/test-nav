...
const Toast = class {
  ...
  render() {
    return (index.h(index.Host, { id: this.toastId, class: "bal-toast" }, index.h("div", { role: "alert", onClick: () => this.close(), class: `bal-toast__inner ${this.colorType}` }, index.h("span", { class: "bal-toast__label", innerHTML: this.message, "data-testid": "bal-toast-label" }, index.h("slot", null)), index.h("bal-close", { class: "bal-toast__close", inverted: false, "data-testid": "bal-toast-close" }))));
  }
