...
const Notification = class {
  ...
  render() {
    return (index.h(index.Host, { class: "bal-notification" }, index.h("div", { class: `bal-notification__inner bal-notification__inner--is-${this.color}`, "data-testid": "bal-notification-content" }, index.h("slot", null))));
  }
};
Notification.style = {
...
exports.bal_notification = Notification;
