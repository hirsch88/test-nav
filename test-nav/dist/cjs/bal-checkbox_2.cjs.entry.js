...
const CheckboxGroup = class {
  constructor(hostRef) {
    ...
    this.onClick = (ev) => {
      ...
      if (!index_esm.areArraysEqual(this.value, newValue)) {
        this.value = [...newValue];
  ...
  valueChanged(_value, oldValue) {
    if (this.control) {
      if (!index_esm.areArraysEqual(this.value, oldValue)) {
        this.onOptionChange();
      }
    }
    else {
