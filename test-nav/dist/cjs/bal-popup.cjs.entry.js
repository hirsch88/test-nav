...
class PopoverVariantRenderer extends AbstractVariantRenderer {
  ...
  async present(component) {
    if (!component.trigger && browser.balBrowser.hasDocument) {
    ...
    if (component.trigger && component.containerEl && component.arrowEl) {
      ...
      if (this.reference && browser.balBrowser.hasDocument) {
...
const Popup = class {
  constructor(hostRef) {
    ...
    this.debouncedGlobalClick = helpers.debounce((trigger) => this.notifyGlobalClick(trigger), 10);
  ...
  async listenOnGlobalClick(ev) {
    ...
    if (trigger && browser.balBrowser.hasWindow) {
  ...
  async listenOnKeyDown(ev) {
    if (this.activeClosable && this.presented && index_esm.isEscapeKey(ev)) {
  ...
  focusFirstDescendant() {
    const { el } = this;
    const firstInput = el.querySelector(focusVisible.focusableQueryString);
    if (firstInput) {
      firstInput.focus();
    }
    else {
  ...
  render() {
    const block = bem.BEM.block('popup');
    ...
    return (index.h(index.Host, { class: Object.assign({}, block.class()), role: "dialog", "aria-hidden": `${this.presented !== true}`, "aria-modal": `${this.presented === true}`, "aria-presented": `${this.presented === true}`, "aria-labelledby": `${this.popupId}-heading` }, index.h("div", { class: Object.assign({}, backdropBlock.class()), ref: backdropEl => (this.backdropEl = backdropEl) }), index.h("div", { class: Object.assign(Object.assign({}, containerBlock.class()), containerBlock.modifier(`variant-${this.activeVariant}`).class()), ref: containerEl => (this.containerEl = containerEl) }, index.h("div", { class: Object.assign({}, arrowBlock.class()), ref: arrowEl => (this.arrowEl = arrowEl) }), index.h("bal-stack", { layout: "vertical", px: this.activeVariant === 'popover' ? 'medium' : 'none', py: "medium", class: Object.assign({}, innerBlock.class()) }, this.label ? (index.h("bal-stack", { space: "auto", class: Object.assign({}, innerHeadBlock.class()) }, index.h("bal-heading", { "data-test": "bal-popup-label", level: "span", "visual-level": "large", id: `${this.popupId}-heading` }, this.label), this.activeClosable ? (index.h("bal-close", { "data-test": "bal-popup-close", tabindex: -1, onClick: () => this.onCloseClick() })) : (''))) : (''), index.h("div", { class: Object.assign({}, innerContentBlock.class()), ref: contentEl => (this.contentEl = contentEl), "data-test": "bal-popup-content" }, index.h("slot", null))))));
  }
