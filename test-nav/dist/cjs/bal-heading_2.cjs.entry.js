...
const Heading = class {
  ...
  get rows() {
    if (this.headingEl && browser.balBrowser.hasWindow) {
...
exports.bal_heading = Heading;
exports.bal_text = Text;
