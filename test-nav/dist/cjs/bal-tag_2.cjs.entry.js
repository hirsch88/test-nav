...
const Tag = class {
  constructor(hostRef) {
    ...
    this.balCloseClick = index.createEvent(this, "balCloseClick", 7);
  ...
  componentWillLoad() {
    this.inheritedAttributes = attributes.inheritAttributes(this.el, ['aria-label', 'title']);
    this.inheritedAttributesClose = attributes.inheritAttributes(this.el, ['tabindex']);
  }
  render() {
    const block = bem.BEM.block('tag');
...
const TagGroup = class {
  ...
  render() {
    return (index.h(index.Host, { class: "bal-tag-group" }, index.h("slot", null)));
  }
};

exports.bal_tag = Tag;
exports.bal_tag_group = TagGroup;
