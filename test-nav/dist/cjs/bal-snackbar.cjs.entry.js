...
const Snackbar = class {
  constructor(hostRef) {
    ...
    this.balClose = index.createEvent(this, "balClose", 7);
    this.balAction = index.createEvent(this, "balAction", 7);
  ...
  render() {
    ...
    return (index.h(index.Host, { id: this.snackbarId, class: "bal-snackbar" }, index.h("div", { role: "alert", class: `bal-snackbar__inner ${this.animationClass} ${this.colorType}` }, index.h("div", { class: "bal-snackbar__header" }, index.h("span", { class: "icon-text is-size-small" }, index.h("span", { class: "icon", style: { display: this.icon ? '' : 'none' } }, index.h("bal-icon", { name: this.icon, color: 'primary' })), index.h("bal-heading", { level: "h5", space: "none", "data-testid": "bal-snackbar-heading" }, this.subject))), index.h("span", Object.assign({ class: "bal-snackbar__label", "data-testid": "bal-snackbar-label" }, labelAttributes), index.h("slot", null), index.h("span", { class: "hidden" })), index.h("bal-close", { class: "bal-snackbar__close", "data-testid": "bal-snackbar-close", onClick: () => this.close() }), index.h("div", { class: "bal-snackbar__footer", style: { display: this.action === '' ? 'none' : 'inline-flex' } }, index.h("bal-button", { color: "info", href: this.href, target: this.target, onClick: () => this.onActionHandler(), "data-testid": "bal-snackbar-action" }, this.action)))));
  }
