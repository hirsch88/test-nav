...
const balLogoCss = ".bal-logo{position:static;display:block;height:1.25rem}.bal-logo svg{-webkit-transform:unset !important;transform:unset !important}.bal-logo svg svg,.bal-logo svg g,.bal-logo svg path,.bal-logo svg circle{fill:#000d6e}.bal-logo>div{height:1.25rem}@media screen and (min-width: 1024px){.bal-logo--animated{margin-left:-7px}}.bal-logo--white svg svg,.bal-logo--white svg g,.bal-logo--white svg path,.bal-logo--white svg circle{fill:#fff}@media screen and (min-width: 1024px){.bal-logo{height:2rem}.bal-logo>div{height:2rem}}";
  ...
  async loadAnimation() {
    return new Promise((resolve, reject) => {
      if (this.animationFunction) {
        ...
        helpers.rIC(async () => {
          Promise.resolve().then(function () { return require('./bal-logo.animation-b69e04d3.js'); })
            .then(module => {
