...
var lzString = _commonjsHelpers.createCommonjsModule(function (module) {
...
var define$1 = _commonjsHelpers.createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
var define = _commonjsHelpers.createCommonjsModule(function (module, exports) {
...
const DocCodeSandbox = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: {
      ...
      } }, index.h("bal-doc-app", null, index.h("form", { action: "https://codesandbox.io/api/v1/sandboxes/define", method: "POST", target: "_blank" }, index.h("input", { type: "hidden", name: "parameters", value: this.parameters }), index.h("bal-button", { elementType: 'submit' }, index.h("div", { class: "is-flex fg-xx-small" }, index.h("div", { innerHTML: this.logo ? logoCodeSandbox : logo, style: { width: '24px', height: '24px' } }), index.h("span", null, this.label ? this.label : `${labels[this.framework] || 'Angular'} Code Sandbox`)))))));
  }
...
exports.bal_doc_code_sandbox = DocCodeSandbox;
