...
const Icon = class {
  constructor(hostRef) {
    ...
    this.icons = initialize.defaultConfig.icons;
    this.name = '';
    this.svg = '';
    this.size = '';
    this.color = '';
