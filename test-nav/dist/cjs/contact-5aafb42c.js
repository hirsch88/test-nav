...
const $a2188ba8c266b376$export$86ae6e8ac17a67c6 = Object.freeze({
    Horizontal: [
        ...
        exports.Direction.Right
    ],
    Vertical: [
        exports.Direction.Up,
        exports.Direction.Down
    ],
    All: [
        exports.Direction.Left,
        exports.Direction.Right,
...
})(exports.GestureState || (exports.GestureState = {}));
exports.PointerManagerState = void 0;
...
})(exports.PointerManagerState || (exports.PointerManagerState = {}));
exports.PointerListenerState = void 0;
...
})(exports.PointerListenerState || (exports.PointerListenerState = {}));
...
class $c0ee1a209fd4fc8d$export$9b781de7bf37bf48 {
    ...
    constructor(startPoint, endPoint){
        ...
        this.direction = (exports.Direction).None;
        ...
        if (Math.abs(this.deltaX) > Math.abs(this.deltaY)) {
            // left or right
            if (this.startPoint.x < this.endPoint.x) this.direction = (exports.Direction).Right;
            else if (this.startPoint.x > this.endPoint.x) this.direction = (exports.Direction).Left;
        } else {
            // up or down
            if (this.startPoint.y < this.endPoint.y) this.direction = (exports.Direction).Down;
            else if (this.startPoint.y > this.endPoint.y) this.direction = (exports.Direction).Up;
        }
    }
}
...
class $1f7944f1763e45ce$export$2db6c17465f94a2 {
    static getVector(startPointerEvent, endPointerEvent) {
        const startPoint = new ($07c7ab2351895186$export$baf26146a414f24a)(startPointerEvent.clientX, startPointerEvent.clientY);
        const endPoint = new ($07c7ab2351895186$export$baf26146a414f24a)(endPointerEvent.clientX, endPointerEvent.clientY);
        const vector = new ($c0ee1a209fd4fc8d$export$9b781de7bf37bf48)(startPoint, endPoint);
        return vector;
    }
  ...
  */ static calculateRotationAngle(vector_1, vector_2) {
        ...
        const angleVector_1 = new ($c0ee1a209fd4fc8d$export$9b781de7bf37bf48)(vector_1.startPoint, vector_2.startPoint); // in time: occured first
        const angleVector_2 = new ($c0ee1a209fd4fc8d$export$9b781de7bf37bf48)(vector_1.endPoint, vector_2.endPoint); // in time: occured second
        const origin = new ($07c7ab2351895186$export$baf26146a414f24a)(0, 0);
    ...
    */ const translationVector_1 = new ($c0ee1a209fd4fc8d$export$9b781de7bf37bf48)(angleVector_1.startPoint, origin);
        ...
        const translationVector_2 = new ($c0ee1a209fd4fc8d$export$9b781de7bf37bf48)(angleVector_2.startPoint, origin);
    ...
    */ const rotationAngle = this.calcAngleRad(translatedEndPoint_1) * -1;
    ...
    static translatePoint(point, vector) {
        ...
        const translatedPoint = new ($07c7ab2351895186$export$baf26146a414f24a)(newX, newY);
    ...
    static getCenter(pointA, pointB) {
        ...
        const center = new ($07c7ab2351895186$export$baf26146a414f24a)(centerX, centerY);
        return center;
    }
    static getCenterMovementVector(vector_1, vector_2) {
        ...
        const vectorBetweenCenterPoints = new ($c0ee1a209fd4fc8d$export$9b781de7bf37bf48)(startPoint, endPoint);
        return vectorBetweenCenterPoints;
    }
    static calculateDistanceChange(vector_1, vector_2) {
        const vectorBetweenStartPoints = new ($c0ee1a209fd4fc8d$export$9b781de7bf37bf48)(vector_1.startPoint, vector_2.startPoint);
        const vectorBetweenEndPoints = new ($c0ee1a209fd4fc8d$export$9b781de7bf37bf48)(vector_1.endPoint, vector_2.endPoint);
...
class $d25d2392b002d8dc$export$b56007f12edf0c17 {
    constructor(pointerEvent, options){
        ...
        this.state = exports.PointerState.Active;
        const nullVector = ($1f7944f1763e45ce$export$2db6c17465f94a2).getVector(pointerEvent, pointerEvent);
    ...
    onPointerUp(pointerupEvent) {
        ...
        this.state = exports.PointerState.Removed;
    ...
    onPointerCancel(pointercancelEvent) {
        ...
        this.parameters.live.speed = 0;
        this.state = exports.PointerState.Canceled;
        this.parameters.live.isMoving = false;
    ...
    update(pointerEvent) {
        ...
        const liveVector = ($1f7944f1763e45ce$export$2db6c17465f94a2).getVector(timedPointerEvents[0], timedPointerEvents[1]);
        this.parameters.live.vector = liveVector;
        this.parameters.live.distance = liveVector.vectorLength;
        this.parameters.live.speed = ($1f7944f1763e45ce$export$2db6c17465f94a2).getSpeed(liveVector, timedPointerEvents[0].timeStamp, timedPointerEvents[1].timeStamp);
        ...
        const globalVector = ($1f7944f1763e45ce$export$2db6c17465f94a2).getVector(this.initialPointerEvent, this.currentPointerEvent);
...
class $f752273e736c5336$export$6e9c3b1e1fa2b597 extends ($24f1c062f8ef0b30$export$9d2aa32114ab0612) {
}
class $f752273e736c5336$export$61ce360501d38a6f {
    constructor(domElement, options){
        this.state = (exports.GestureState).Inactive;
        this.validPointerManagerState = null;
        this.validPointerInputConstructor = ($5fe7e4b452e08fad$export$bbcc47898202c6b8);
    ...
    getGestureParameters() {
        ...
        if (this.state == (exports.GestureState).Active) {
    ...
    validateGestureState() {
        if (this.state == (exports.GestureState).Blocked) return false;
        return true;
    }
    ...
    recognize(pointerManager) {
        ...
        if (isValid == true && this.state == (exports.GestureState).Inactive) this.onStart(pointerManager);
        if (isValid == true && this.state == (exports.GestureState).Active) {
            if (this.initialPointerEvent == null) this.setInitialPointerEvent(pointerManager);
            this.emit(pointerManager);
        } else if (this.state == (exports.GestureState).Active && isValid == false) this.onEnd(pointerManager);
   ...
   */ getPointerInput(pointerManager) {
        ...
        else if (pointerManager.lastRemovedPointer instanceof ($d25d2392b002d8dc$export$b56007f12edf0c17)) {
    ...
    emit(pointerManager, eventName) {
        ...
        if (pointerInput != null) {
            ...
            if (target instanceof EventTarget) {
                ...
                if (hasSupportedDirections == true && currentDirection != (exports.Direction).None && (eventName == this.eventBaseName || eventName == "swipe")) for(let d = 0; d < this.options.supportedDirections.length; d++){
    ...
    onStart(pointerManager) {
        this.blockGestures();
        this.state = (exports.GestureState).Active;
    ...
    onEnd(pointerManager) {
        ...
        if (this.DEBUG == true) console.log(`[${this.eventBaseName}] ended. Setting ${this.eventBaseName}.state = ${(exports.GestureState).Inactive}`);
        this.state = (exports.GestureState).Inactive;
    ...
    blockGestures() {
        for(let g = 0; g < this.options.blocks.length; g++){
            ...
            if (gesture.state == (exports.GestureState).Inactive) {
                if (this.DEBUG == false) console.log(`[Gesture] blocking ${gesture.eventBaseName}`);
                gesture.state = (exports.GestureState).Blocked;
            }
        }
    }
    unblockGestures() {
        for(let g = 0; g < this.options.blocks.length; g++){
            const gesture = this.options.blocks[g];
            gesture.state = (exports.GestureState).Inactive;
        }
    }
...
class $e8978caba4d46d00$export$718b85c80185d86e extends ($f752273e736c5336$export$61ce360501d38a6f) {
    constructor(domElement, options){
        super(domElement, options);
        this.initialPointerEvent = null;
        this.validPointerManagerState = (exports.PointerManagerState).SinglePointer;
    ...
    getEventData(singlePointerInput, pointerManager) {
        ...
        if (this.initialPointerEvent != null) {
            const globalStartPoint = new ($07c7ab2351895186$export$baf26146a414f24a)(this.initialPointerEvent.clientX, this.initialPointerEvent.clientY);
            const globalEndPoint = new ($07c7ab2351895186$export$baf26146a414f24a)(singlePointerInput.pointer.currentPointerEvent.clientX, singlePointerInput.pointer.currentPointerEvent.clientY);
            globalVector = new ($c0ee1a209fd4fc8d$export$9b781de7bf37bf48)(globalStartPoint, globalEndPoint);
...
class $b6ec4e8a6d9d51ec$export$4451a18ddc7083b7 extends ($e8978caba4d46d00$export$718b85c80185d86e) {
    constructor(domElement, options){
        super(domElement, options);
        this.validPointerManagerState = (exports.PointerManagerState).NoPointer;
    ...
    validate(pointerManager) {
        ...
        if (isValid === true) {
            if (pointerManager.lastInputSessionPointerCount != 1) return false;
                ...
                if (singlePointerInput instanceof ($5fe7e4b452e08fad$export$bbcc47898202c6b8)) isValid = this.validateGestureParameters(singlePointerInput);
                else isValid = false;
            }
        }
        return isValid;
...
class $5653a1f5fdc2db30$export$90610caf6d8d0242 extends ($e8978caba4d46d00$export$718b85c80185d86e) {
    ...
    recognize(pointerManager) {
        ...
        if (singlePointerInput instanceof ($5fe7e4b452e08fad$export$bbcc47898202c6b8)) {
...
class $7a0f7fd2f33d0212$export$f86166cd6057c2d1 extends ($e8978caba4d46d00$export$718b85c80185d86e) {
    constructor(domElement, options){
        super(domElement, options);
        this.validPointerManagerState = (exports.PointerManagerState).SinglePointer;
        ...
        this.isSwipe = false;
        this.options.supportedDirections = options?.supportedDirections ?? ($a2188ba8c266b376$export$86ae6e8ac17a67c6).All;
    ...
    validate(pointerManager) {
        ...
        if (this.state == (exports.GestureState).Active) this.options.supportedDirections = ($a2188ba8c266b376$export$86ae6e8ac17a67c6).All;
    ...
    onEnd(pointerManager) {
        const singlePointerInput = pointerManager.getlastRemovedPointerInput();
        if (singlePointerInput instanceof ($5fe7e4b452e08fad$export$bbcc47898202c6b8)) {
            if (this.swipeFinalSpeed < singlePointerInput.parameters.global.finalSpeed && singlePointerInput.parameters.live.vector.direction != (exports.Direction).None) {
                this.isSwipe = true;
...
class $ba0aae203ff6b3f9$export$bdba51b3ce92d5f1 {
    constructor(pointer_1, pointer_2){
        ...
        const globalCenter = ($1f7944f1763e45ce$export$2db6c17465f94a2).getCenter(globalVector_1.startPoint, globalVector_2.startPoint);
        const globalCenterMovementVector = ($1f7944f1763e45ce$export$2db6c17465f94a2).getCenterMovementVector(globalVector_1, globalVector_2);
        const globalParameters = {
            duration: 0,
            center: globalCenter,
        ...
        const liveCenter = ($1f7944f1763e45ce$export$2db6c17465f94a2).getCenter(liveVector_1.startPoint, liveVector_2.startPoint);
        const liveCenterMovementVector = ($1f7944f1763e45ce$export$2db6c17465f94a2).getCenterMovementVector(liveVector_1, liveVector_2);
        const liveParameters = {
            center: liveCenter,
    ...
    update(pointerEvent) {
        ...
        const globalCenter = ($1f7944f1763e45ce$export$2db6c17465f94a2).getCenter(globalVector_1.startPoint, globalVector_2.startPoint);
        const globalCenterMovementVector = ($1f7944f1763e45ce$export$2db6c17465f94a2).getCenterMovementVector(globalVector_1, globalVector_2);
        const globalAbsoluteDistanceChange = ($1f7944f1763e45ce$export$2db6c17465f94a2).calculateAbsoluteDistanceChange(globalVector_1, globalVector_2);
        const globalRelativeDistanceChange = ($1f7944f1763e45ce$export$2db6c17465f94a2).calculateRelativeDistanceChange(globalVector_1, globalVector_2);
        const globalRotationAngle = ($1f7944f1763e45ce$export$2db6c17465f94a2).calculateRotationAngle(globalVector_1, globalVector_2);
        const globalVectorAngle = ($1f7944f1763e45ce$export$2db6c17465f94a2).calculateVectorAngle(globalVector_1, globalVector_2);
        ...
        const liveCenter = ($1f7944f1763e45ce$export$2db6c17465f94a2).getCenter(liveVector_1.startPoint, liveVector_2.startPoint);
        const liveCenterMovementVector = ($1f7944f1763e45ce$export$2db6c17465f94a2).getCenterMovementVector(liveVector_1, liveVector_2);
        const liveAbsoluteDistanceChange = ($1f7944f1763e45ce$export$2db6c17465f94a2).calculateAbsoluteDistanceChange(liveVector_1, liveVector_2);
        const liveRelativeDistanceChange = ($1f7944f1763e45ce$export$2db6c17465f94a2).calculateRelativeDistanceChange(liveVector_1, liveVector_2);
        // calculate rotation angle. imagine the user turning a wheel with 2 fingers
        const liveRotationAngle = ($1f7944f1763e45ce$export$2db6c17465f94a2).calculateRotationAngle(liveVector_1, liveVector_2);
        const liveVectorAngle = ($1f7944f1763e45ce$export$2db6c17465f94a2).calculateVectorAngle(liveVector_1, liveVector_2);
...
class $a1a4c2869495e604$export$f9d89efe4b7795e7 extends ($f752273e736c5336$export$61ce360501d38a6f) {
    constructor(domElement, options){
        super(domElement, options);
        this.initialPointerEvent_1 = null;
        this.initialPointerEvent_2 = null;
        this.validPointerManagerState = (exports.PointerManagerState).DualPointer;
        this.validPointerInputConstructor = ($ba0aae203ff6b3f9$export$bdba51b3ce92d5f1);
        const nullRecognitionParameters = this.getEmptyGestureParameters();
        this.initialParameters = {
            ...nullRecognitionParameters
        };
...
class $ed7931f1d96d5294$export$826ae541ddf1527b extends ($a1a4c2869495e604$export$f9d89efe4b7795e7) {
    constructor(domElement, options){
        super(domElement, options);
...
class $9fe2bb90b337f66c$export$152db69a76b6b79e extends ($a1a4c2869495e604$export$f9d89efe4b7795e7) {
    constructor(domElement, options){
        super(domElement, options);
...
class $59226122237c359c$export$8847187e02a498e8 extends ($a1a4c2869495e604$export$f9d89efe4b7795e7) {
    constructor(domElement, options){
        super(domElement, options);
...
class $4f5a7b355079efa2$export$af6d1be017a420a {
    constructor(options){
        ...
        this.DEBUG = this.options.DEBUG;
        this.state = (exports.PointerManagerState).NoPointer;
    ...
    addPointer(pointerdownEvent) {
        ...
        const pointer = new ($d25d2392b002d8dc$export$b56007f12edf0c17)(pointerdownEvent, pointerOptions);
        this.onSurfacePointers[pointer.pointerId] = pointer;
        if (this.activePointerInput == null) this.setActiveSinglePointerInput(pointer);
        else if (this.activePointerInput instanceof ($5fe7e4b452e08fad$export$bbcc47898202c6b8)) this.setActiveDualPointerInput(this.activePointerInput.pointer, pointer);
        else if (this.activePointerInput instanceof ($ba0aae203ff6b3f9$export$bdba51b3ce92d5f1)) this.unusedPointers[pointer.pointerId] = pointer;
   ...
   */ removePointer(pointerId) {
        ...
        if (this.activePointerInput instanceof ($ba0aae203ff6b3f9$export$bdba51b3ce92d5f1)) {
            if (this.activePointerInput.pointerIds.has(pointerId)) {
                ...
                if (unusedPointerInput instanceof ($d25d2392b002d8dc$export$b56007f12edf0c17)) this.setActiveDualPointerInput(remainingPointer, unusedPointerInput);
        ...
        } else if (this.activePointerInput instanceof ($5fe7e4b452e08fad$export$bbcc47898202c6b8)) {
    ...
    setActiveSinglePointerInput(pointer) {
        pointer.reset();
        const singlePointerInput = new ($5fe7e4b452e08fad$export$bbcc47898202c6b8)(pointer);
        ...
        this.state = (exports.PointerManagerState).SinglePointer;
        if (this.DEBUG == true) console.log(`[PointerManager] state: ${this.state}`);
    }
    setActiveDualPointerInput(pointer_1, pointer_2) {
        pointer_1.reset();
        pointer_2.reset();
        const dualPointerInput = new ($ba0aae203ff6b3f9$export$bdba51b3ce92d5f1)(pointer_1, pointer_2);
        ...
        this.state = (exports.PointerManagerState).DualPointer;
        if (this.DEBUG == true) console.log(`[PointerManager] state: ${this.state}`);
    }
    ...
    getlastRemovedPointerInput() {
        if (this.lastRemovedPointer instanceof ($d25d2392b002d8dc$export$b56007f12edf0c17)) return this.pointerAllocation[this.lastRemovedPointer.pointerId];
        return null;
    }
    onIdle() {
   ...
   */ onPointerMove(pointermoveEvent) {
        ...
        if (pointer instanceof ($d25d2392b002d8dc$export$b56007f12edf0c17)) pointer.onPointerMove(pointermoveEvent);
    ...
    onPointerUp(pointerupEvent) {
        ...
        if (pointer instanceof ($d25d2392b002d8dc$export$b56007f12edf0c17)) pointer.onPointerUp(pointerupEvent);
  ...
  onPointerOut(pointeroutEvent: PointerEvent): void {
    ...
    this.removePointer(pointeroutEvent.pointerId);
        ...
        if (pointer instanceof ($d25d2392b002d8dc$export$b56007f12edf0c17)) pointer.onPointerCancel(pointercancelEvent);
...
const $03c52e54621b9b86$var$ALL_GESTURE_CLASSES = [
    ($b6ec4e8a6d9d51ec$export$4451a18ddc7083b7),
    ($5653a1f5fdc2db30$export$90610caf6d8d0242),
    ($7a0f7fd2f33d0212$export$f86166cd6057c2d1),
    ($ed7931f1d96d5294$export$826ae541ddf1527b),
    ($9fe2bb90b337f66c$export$152db69a76b6b79e),
    ($59226122237c359c$export$8847187e02a498e8)
];
class $03c52e54621b9b86$export$9371bd96776f4e82 {
    constructor(domElement, options){
        this.state = (exports.PointerListenerState).NoActiveGesture;
        this.activeGestures = [];
        ...
        this.pointerManager = new ($4f5a7b355079efa2$export$af6d1be017a420a)(pointerManagerOptions);
   ...
   */ recognizeGestures() {
        ...
        if (this.options.simultaneousGestures == false && this.state == (exports.PointerListenerState).ActiveGesture) gesturesForRecognition = [
            this.activeGestures[0]
        ];
        else if (this.options.consecutiveGestures == false && this.state == (exports.PointerListenerState).ActiveGesture) gesturesForRecognition = [
            this.activeGestures[0]
        ];
        else if (this.options.consecutiveGestures == false && this.state == (exports.PointerListenerState).NoActiveGesture) {
        ...
        for(let g = 0; g < gesturesForRecognition.length; g++){
            ...
            if (this.options.simultaneousGestures == false && this.state == (exports.PointerListenerState).ActiveGesture) break;
        }
    ...
    updateActiveGestures(gesture) {
        if (gesture.state == (exports.GestureState).Active) {
        ...
        if (this.activeGestures.length > 0) this.state = (exports.PointerListenerState).ActiveGesture;
        else this.state = (exports.PointerListenerState).NoActiveGesture;
    }
    /*
   *	handler management
...
exports.Directions = $a2188ba8c266b376$export$86ae6e8ac17a67c6;
exports.Geometry = $1f7944f1763e45ce$export$2db6c17465f94a2;
exports.GestureEvent = $f752273e736c5336$export$6e9c3b1e1fa2b597;
exports.Pan = $7a0f7fd2f33d0212$export$f86166cd6057c2d1;
exports.Pinch = $ed7931f1d96d5294$export$826ae541ddf1527b;
exports.PointerListener = $03c52e54621b9b86$export$9371bd96776f4e82;
exports.Press = $5653a1f5fdc2db30$export$90610caf6d8d0242;
exports.Rotate = $9fe2bb90b337f66c$export$152db69a76b6b79e;
exports.Tap = $b6ec4e8a6d9d51ec$export$4451a18ddc7083b7;
exports.TwoFingerPan = $59226122237c359c$export$8847187e02a498e8;
