...
class BalMutationListener extends listener.ListenerAbstract {
  constructor(options) {
    super();
    this.tags = [];
...
class BalMutationSubject extends listener.SingleSubject {
  constructor(options) {
    super(observer => {
...
exports.ListenToMutation = ListenToMutation;
