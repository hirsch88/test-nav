...
class $c0ee1a209fd4fc8d$export$9b781de7bf37bf48 {
    ...
    constructor(startPoint, endPoint){
        ...
        this.direction = ($a2188ba8c266b376$export$cacd6541cfeeb6c1).None;
        ...
        if (Math.abs(this.deltaX) > Math.abs(this.deltaY)) {
            // left or right
            if (this.startPoint.x < this.endPoint.x) this.direction = ($a2188ba8c266b376$export$cacd6541cfeeb6c1).Right;
            else if (this.startPoint.x > this.endPoint.x) this.direction = ($a2188ba8c266b376$export$cacd6541cfeeb6c1).Left;
        } else {
            // up or down
            if (this.startPoint.y < this.endPoint.y) this.direction = ($a2188ba8c266b376$export$cacd6541cfeeb6c1).Down;
            else if (this.startPoint.y > this.endPoint.y) this.direction = ($a2188ba8c266b376$export$cacd6541cfeeb6c1).Up;
        }
    }
}
...
class $f752273e736c5336$export$61ce360501d38a6f {
    constructor(domElement, options){
        this.state = ($a2188ba8c266b376$export$a1d3109c03b1d511).Inactive;
    ...
    getGestureParameters() {
        ...
        if (this.state == ($a2188ba8c266b376$export$a1d3109c03b1d511).Active) {
    ...
    validateGestureState() {
        if (this.state == ($a2188ba8c266b376$export$a1d3109c03b1d511).Blocked) return false;
        return true;
    }
    ...
    recognize(pointerManager) {
        ...
        if (isValid == true && this.state == ($a2188ba8c266b376$export$a1d3109c03b1d511).Inactive) this.onStart(pointerManager);
        if (isValid == true && this.state == ($a2188ba8c266b376$export$a1d3109c03b1d511).Active) {
            if (this.initialPointerEvent == null) this.setInitialPointerEvent(pointerManager);
            this.emit(pointerManager);
        } else if (this.state == ($a2188ba8c266b376$export$a1d3109c03b1d511).Active && isValid == false) this.onEnd(pointerManager);
   ...
   */ getPointerInput(pointerManager) {
    ...
    emit(pointerManager, eventName) {
        ...
        if (pointerInput != null) {
            ...
            if (target instanceof EventTarget) {
                ...
                if (hasSupportedDirections == true && currentDirection != ($a2188ba8c266b376$export$cacd6541cfeeb6c1).None && (eventName == this.eventBaseName || eventName == "swipe")) for(let d = 0; d < this.options.supportedDirections.length; d++){
    ...
    onStart(pointerManager) {
        this.blockGestures();
        this.state = ($a2188ba8c266b376$export$a1d3109c03b1d511).Active;
    ...
    onEnd(pointerManager) {
        ...
        if (this.DEBUG == true) console.log(`[${this.eventBaseName}] ended. Setting ${this.eventBaseName}.state = ${($a2188ba8c266b376$export$a1d3109c03b1d511).Inactive}`);
        this.state = ($a2188ba8c266b376$export$a1d3109c03b1d511).Inactive;
    ...
    blockGestures() {
        for(let g = 0; g < this.options.blocks.length; g++){
            ...
            if (gesture.state == ($a2188ba8c266b376$export$a1d3109c03b1d511).Inactive) {
                if (this.DEBUG == false) console.log(`[Gesture] blocking ${gesture.eventBaseName}`);
                gesture.state = ($a2188ba8c266b376$export$a1d3109c03b1d511).Blocked;
            }
        }
    }
    unblockGestures() {
        for(let g = 0; g < this.options.blocks.length; g++){
            const gesture = this.options.blocks[g];
            gesture.state = ($a2188ba8c266b376$export$a1d3109c03b1d511).Inactive;
        }
    }
...
class $e8978caba4d46d00$export$718b85c80185d86e extends ($f752273e736c5336$export$61ce360501d38a6f) {
    constructor(domElement, options){
        ...
        this.initialPointerEvent = null;
        this.validPointerManagerState = ($a2188ba8c266b376$export$b8339a9622c147c0).SinglePointer;
...
class $b6ec4e8a6d9d51ec$export$4451a18ddc7083b7 extends ($e8978caba4d46d00$export$718b85c80185d86e) {
    constructor(domElement, options){
        super(domElement, options);
        this.validPointerManagerState = ($a2188ba8c266b376$export$b8339a9622c147c0).NoPointer;
...
class $7a0f7fd2f33d0212$export$f86166cd6057c2d1 extends ($e8978caba4d46d00$export$718b85c80185d86e) {
    ...
    validate(pointerManager) {
        ...
        if (this.state == ($a2188ba8c266b376$export$a1d3109c03b1d511).Active) this.options.supportedDirections = ($a2188ba8c266b376$export$86ae6e8ac17a67c6).All;
    ...
    onEnd(pointerManager) {
        const singlePointerInput = pointerManager.getlastRemovedPointerInput();
        if (singlePointerInput instanceof ($5fe7e4b452e08fad$export$bbcc47898202c6b8)) {
            if (this.swipeFinalSpeed < singlePointerInput.parameters.global.finalSpeed && singlePointerInput.parameters.live.vector.direction != ($a2188ba8c266b376$export$cacd6541cfeeb6c1).None) {
                this.isSwipe = true;
...
class $a1a4c2869495e604$export$f9d89efe4b7795e7 extends ($f752273e736c5336$export$61ce360501d38a6f) {
    constructor(domElement, options){
        ...
        this.validPointerManagerState = ($a2188ba8c266b376$export$b8339a9622c147c0).DualPointer;
...
class $4f5a7b355079efa2$export$af6d1be017a420a {
    constructor(options){
        ...
        this.DEBUG = this.options.DEBUG;
        this.state = ($a2188ba8c266b376$export$b8339a9622c147c0).NoPointer;
   ...
   */ removePointer(pointerId) {
    ...
    setActiveSinglePointerInput(pointer) {
        ...
        this.state = ($a2188ba8c266b376$export$b8339a9622c147c0).SinglePointer;
        if (this.DEBUG == true) console.log(`[PointerManager] state: ${this.state}`);
    }
    setActiveDualPointerInput(pointer_1, pointer_2) {
        ...
        this.state = ($a2188ba8c266b376$export$b8339a9622c147c0).DualPointer;
        if (this.DEBUG == true) console.log(`[PointerManager] state: ${this.state}`);
    }
...
class $03c52e54621b9b86$export$9371bd96776f4e82 {
    constructor(domElement, options){
        this.state = ($a2188ba8c266b376$export$2fb579dd5dfdbea).NoActiveGesture;
        this.activeGestures = [];
   ...
   */ recognizeGestures() {
        ...
        if (this.options.simultaneousGestures == false && this.state == ($a2188ba8c266b376$export$2fb579dd5dfdbea).ActiveGesture) gesturesForRecognition = [
            this.activeGestures[0]
        ];
        else if (this.options.consecutiveGestures == false && this.state == ($a2188ba8c266b376$export$2fb579dd5dfdbea).ActiveGesture) gesturesForRecognition = [
            this.activeGestures[0]
        ];
        else if (this.options.consecutiveGestures == false && this.state == ($a2188ba8c266b376$export$2fb579dd5dfdbea).NoActiveGesture) {
        ...
        for(let g = 0; g < gesturesForRecognition.length; g++){
            ...
            if (this.options.simultaneousGestures == false && this.state == ($a2188ba8c266b376$export$2fb579dd5dfdbea).ActiveGesture) break;
        }
    ...
    updateActiveGestures(gesture) {
        if (gesture.state == ($a2188ba8c266b376$export$a1d3109c03b1d511).Active) {
        ...
        if (this.activeGestures.length > 0) this.state = ($a2188ba8c266b376$export$2fb579dd5dfdbea).ActiveGesture;
        else this.state = ($a2188ba8c266b376$export$2fb579dd5dfdbea).NoActiveGesture;
    }
    /*
   *	handler management
