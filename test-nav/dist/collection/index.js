export { attachToConfig, detachFromConfig, defaultConfig, updateBalAllowedLanguages, updateBalAnimated, updateBalIcons, updateBalLanguage, updateBalRegion, onBalConfigChange, useBalConfig, initStyleMode, initialize, } from './utils/config';
...
export { balBreakpoints, balBreakpointSubject } from './utils/breakpoints';
export { balOrientationSubject } from './utils/orientation';
...
export { isPlatform, getPlatforms } from './utils/legacy';
