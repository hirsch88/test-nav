...
export type BalLanguage = BalSwissLanguage | BalLuxembourgLanguage | BalLuxembourgInternationalLanguage | BalBelgiumLanguage | BalGermanLanguage;
export type BalIcons = {
  [key: string]: string;
};
